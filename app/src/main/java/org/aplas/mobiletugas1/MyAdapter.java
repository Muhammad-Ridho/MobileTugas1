...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            textView1 = itemView.findViewById(R.id.judulBungaTxt);
            textView2 = itemView.findViewById(R.id.deskripsiTxt);
            textView3 = itemView.findViewById(R.id.deskripsiTxt);
            myImage = itemView.findViewById(R.id.imgBungaView);
